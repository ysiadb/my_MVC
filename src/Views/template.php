            ...
            if ($_SESSION["isAdmin"] == 1) :
                ...
                <div class="text-end">
                    <?php if ($_SESSION["isAuthor"] == FALSE) : ?>
                        ...
                        <a href="/register"><button type="button" class="btn btn-warning">Inscription</button></a>
                    <?php else : ?>
                        <a href="/logout"><button type="button" class="btn btn-outline-light me-2">Deconnexion</button></a>
                        <a href="/newpost"><button type="button" class="btn btn-outline-light me-2">Nouveau post</button></a>
                    <?php endif; ?>
